...
class DescriptionPredictorClient(BaseMicroserviceClient):
    ...
    def train(self):
        ...
        """
        return self._send_requisition('description_predictor/train', 'post')
    ...
    def predict(self, description: str):
        ...
        return self._send_requisition('description_predictor/predict', 'post', body)
    ...
    def predict_batch(self, transactions: list):
        ...
        return self._send_requisition('description_predictor/predict-batch', 'post', transactions_json)
    ...
    def retrain_from_feedback(self, feedbacks: list):
        ...
        return self._send_requisition('description_predictor/feedback', 'post', serializer.data)
