...
class Card(models.Model):
    ...
    due = models.IntegerField(blank=False, null=False)
    closing = models.IntegerField(blank=False, null=False)
    home_screen = models.BooleanField(default=False,)
    user = models.ForeignKey(Usuario, on_delete=models.PROTECT)
...
class Transaction(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.PROTECT)
    subcategury = models.ForeignKey(Subcategory, on_delete=models.PROTECT)
    description = models.CharField(max_length=50,)
