...
urlpatterns = [
    ...
    path('mes_atual/', get_current_month_invoice_by_card, name='get_current_month_invoice_by_card'),
    path('<int:year>/<int:month>/', get_invoice_by_card_year_and_month, name='get_invoice_by_card_year_and_month'),
]
