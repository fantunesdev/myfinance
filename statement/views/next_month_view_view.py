...
def update_next_month_view(request):
    ...
    if form_next_month_view.is_valid():
        ...
        next_month_view_services.update_next_month_view(old_next_month_view, new_next_month_view)
    ...
    return render(request, 'next_month_view/form_next_month_view.html', templatetags)
