...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'statement.authentication.DeviceTokenAuthentication',
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(LOG_DIR, 'myfinance.log'),
            'when': 'midnight',
            'interval': 1,
            'backupCount': 7,
            'formatter': 'verbose',
    ...
    'loggers': {
        ...
        'myfinance': {  # ajuste esse nome para refletir seu app ou use '' para todos
            'handlers': ['file'],
            'level': 'INFO',
            'propagate': False,
        },
