...
fields = ['data', 'pagamento','conta', 'cartao', 'categoria', 'subcategoria', 'descricao', 'valor', 'parcelas', 'pagas', 'fixa',
          'anual', 'moeda', 'observacao', 'lembrar', 'efetivado', 'tela_inicial']
widgets = {
    'data': forms.DateInput(format='%Y-%m-%d', attrs={'type': 'date',
                                                      'value': hoje,
                                                      'class': 'form-control'}),
    'pagamento': forms.DateInput(format='%Y-%m-%d', attrs={'type': 'date', 'class': 'form-control'}),
